...
function InstagramAdsQuestions() {
    return (
        <div>
                            ...
                            <h1>
                                <AccordionButton className='bat__card-tit' backgroundColor={'inherit'} border={'none'} w={'100%'}>
                                    ...
                                    <Box display={'flex'} alignItems={'center'} justifyContent={'space-between'} w={'100%'}>
                                        <h1> How can i identify a reliable advertising platform? </h1>
                        ...
                        <AccordionItem>
                            <h1>
                                <AccordionButton className='bat__card-tit' backgroundColor={'inherit'} borderLeft={'none'} borderRight={'none'} borderBottom={'none'} w={'100%'}>
                                    <span>02</span>
                                    <Box display={'flex'} alignItems={'center'} justifyContent={'space-between'} w={'100%'}>
                                        <h1>What are the benefits of instagram ads?</h1>
                                        <AccordionIcon w={'50px'} h={'50px'} />
                                    </Box>
                                </AccordionButton>
                            </h1>
                        ...
                        <AccordionItem  >
                            <h1>
                                <AccordionButton className='bat__card-tit' backgroundColor={'inherit'} borderLeft={'none'} borderRight={'none'} borderBottom={'none'} w={'100%'} >
                                    <span>03</span>
                                    <Box display={'flex'} alignItems={'center'} justifyContent={'space-between'} w={'100%'}>
                                        <h1>What kind of services are provided in instagram ads</h1>
                                        <AccordionIcon w={'50px'} h={'50px'} />
                                    </Box>
                                </AccordionButton>
...
export default InstagramAdsQuestions