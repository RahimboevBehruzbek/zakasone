                ...
                <div className="container">
                    ...
                    <img className='google-ads__img-left' src="./src/assets/images/IR.png" alt=""  />
                        ...
                        <div className="instagram-ads__content-text">
                            <h1 className="instagram-ads__content-text__title">Take your business to the next level with  <span className="instagram-ads__content-text__title-blue">instagram ads</span></h1>
