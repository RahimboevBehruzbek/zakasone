      ...
      <div className="container">
        <div className="servis__s">
          ...
          <div className="servis__sub">
            <h1>Choose your platform and publish.</h1>
            <h2>
              Pick your favourite platform to publish your ads and design it
              however you want and publish within seconds with our platform
            </h2>
            ...
            <div className="servis__sm">
              ...
              <div className="servis__titles">
                ...
                <Link to="facebook">
                  {" "}
                  <div className="qq">
                    <button>Try Facebook ads</button>
                  </div>{" "}
                </Link>
              </div>
            </div>
            ...
            <div className="servis__sm">
              ...
              <div className="servis__titles">
                ...
                <Link to="insta">
                  {" "}
                  <div className="qq">
                    <button>Try Instagram ads</button>
                  </div>{" "}
                </Link>
              </div>
            </div>
          ...
          <div className="sss">
            <div className="servis__sm">
              ...
              <div className="servis__titles">
                ...
                <Link to="mcrs">
                  <div className="qq">
                    <button>Try Microsoft ads</button>
                  </div>
                </Link>
              </div>
            </div>
